...
/*   Updated: 2022/09/20 12:22:26 by tvan-der      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
TEST(get_env_var, basic_test1)
{
    char *test = "hi $hello";
    int exit_code = 0;
    char **env_var = get_env_var(test, &exit_code);
...
//     char **env_var = get_env_var(test, 0);
...
// {
//     t_env_var *test = NULL;
//     char **env_var = get_env_var("hello $NAME bye hello $now$", 0);
...
// {
//     t_env_var *test = NULL;
//     char **env_var = get_env_var("hello $HOME and $PWD", 0);
//     create_env_var_list(&test, env_var);
